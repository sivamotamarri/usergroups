module Messaging
  class MessagesController < ApplicationController
    ...
    def create
      @message = MyMessage.new params[:my_message]
      ...
      redirect_to message_show_path(receipt.conversation)
    end
    ...
    def show
      ...
      @message = MyMessage.new conversation_id: @conversation.id
    ...
    def trash
      ...
      redirect_to mymessages_path(box: params[:current_box])
    end
    ...
    def untrash
      ...
      redirect_to mymessages_path(box: 'inbox')
    end
