    ...
    module Messageable
      ...
      module ClassMethods
        ...
        def acts_as_messageable
          has_many :my_messages, :as => :sender
      ...
      def send_message(recipients, msg_body, subject, sanitize_text=true, attachment=nil)
        ...
        message = my_messages.new({:body => msg_body, :subject => subject, :attachment => attachment})
      ...
      def reply(conversation, recipients, reply_body, subject=nil, sanitize_text=true, attachment=nil)
        ...
        response = my_messages.new({:body => reply_body, :subject => subject, :attachment => attachment})
      ...
      def reply_to_sender(receipt, reply_body, subject=nil, sanitize_text=true, attachment=nil)
        return reply(receipt.conversation, receipt.my_message.sender, reply_body, subject, sanitize_text, attachment)
      end
      ...
      def reply_to_all(receipt, reply_body, subject=nil, sanitize_text=true, attachment=nil)
        return reply(receipt.conversation, receipt.my_message.recipients, reply_body, subject, sanitize_text, attachment)
      end
